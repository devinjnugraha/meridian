...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      peakConfirmDelayMs: ["management", "peakConfirmDelayMs"],
      peakConfirmTolerance: ["management", "peakConfirmTolerance"],
      dropConfirmDelayMs: ["management", "dropConfirmDelayMs"],
      dropConfirmTolerancePct: ["management", "dropConfirmTolerancePct"],
